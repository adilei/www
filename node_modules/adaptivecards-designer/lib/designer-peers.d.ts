...
export declare abstract class CardObjectPeer extends DesignerPeer {
    static readonly idProperty: StringPropertyEditor;
}
export declare class ActionPeer extends CardObjectPeer {
...
export declare class CardElementPeer extends CardObjectPeer {
